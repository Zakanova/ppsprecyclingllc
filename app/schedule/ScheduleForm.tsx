...
import { Truck, HardDrive, User, Phone, MapPin, Building, ArrowRight, CheckCircle } from 'lucide-react'
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" name="equipmentType" value={formData.equipmentType} onChange={handleChange}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500" placeholder="Laptops, servers..." />
                </div>
                <div>
